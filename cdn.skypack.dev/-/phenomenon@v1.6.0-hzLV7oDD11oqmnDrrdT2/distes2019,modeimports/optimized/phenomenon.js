var t = ["x", "y", "z"],
    e = function(t2) {
        Object.assign(this, {
            ...
            multiplier: 1,
            buffers: []
        }), Object.assign(this, t2), this.prepareProgram(), this.prepareUniforms(), this.prepareAttributes();
    };
e.prototype.compileShader = function(t2, e2) {
    ...
    this.geometry.vertices !== void 0 && this.attributes.push({
        name: "aPosition",
        size: 3
    }), this.geometry.normal !== void 0 && this.attributes.push({
        name: "aNormal",
        size: 3
    }), this.attributeKeys = [];
    ...
    this.gl.enableVertexAttribArray(n), this.gl.vertexAttribPointer(n, r, 5126, false, 0, 0), this.buffers[this.attributeKeys.indexOf(t2.name)] = {
        buffer: s,
        location: n,
        size: r
    };
...
i.prototype.resize = function() {
    ...
    this.uniforms.uProjectionMatrix = {
        type: "mat4",
        value: [0.5 / o, 0, 0, 0, 0, a / o * 0.5, 0, 0, 0, 0, -(this.clip[1] + this.clip[0]) / (this.clip[1] - this.clip[0]), -1, 0, 0, -2 * this.clip[1] * (this.clip[0] / (this.clip[1] - this.clip[0])), 0]
    ...
    i2 === void 0 && (i2 = {
        uniforms: {}
    }), i2.uniforms === void 0 && (i2.uniforms = {}), Object.assign(i2.uniforms, JSON.parse(JSON.stringify(this.uniforms))), Object.assign(i2, {
        gl: this.gl,
